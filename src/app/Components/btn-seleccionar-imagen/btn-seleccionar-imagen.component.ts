...
@Component({
  ...
  templateUrl: './btn-seleccionar-imagen.component.html',
  styleUrls: ['./btn-seleccionar-imagen.component.scss'],
})
export class BtnSeleccionarImagenComponent implements OnInit {
